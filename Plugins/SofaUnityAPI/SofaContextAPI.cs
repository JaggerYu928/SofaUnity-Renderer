...
#endif
        public int setPosition(int[] values)
        {
            int res = 0;
            res = sofaPhysicsAPI_setPosition(m_native, "vm", values);
            return res;
            //return 5;
        }
...
#endif
        [DllImport("SofaPhysicsAPI")]
        public static extern int sofaPhysicsAPI_setPosition(IntPtr obj, string name, int[] values);
    }
}
